...
// Load emoji dictionary from CSV file
const fs = require('fs');
const csv = require('csv-parser');

const emojiDictionary = {};

fs.createReadStream('/Users/admin/_pasta/emoji_dictionary.csv')
  .pipe(csv())
  .on('data', (row) => {
    emojiDictionary[row.Name] = String.fromCodePoint(parseInt(row.Codepoint.substr(2), 16));
  })
  .on('end', () => {
    console.log('Emoji dictionary loaded successfully!');
  });
